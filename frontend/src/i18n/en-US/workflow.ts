const translation = {
  ...
  blocksAbout: {
    ...
    'process-scheduler': 'A multi-process orchestrator that supports decoupling inter-process communication via message queues, enabling producer/consumer patterns for parallel data processing.',
    'thread-scheduler': 'A multi-threaded orchestrator designed for concurrent execution of I/O-intensive tasks.',
    'mq-producer': 'Pushes data to a specified Topic in the message queue for consumers to subscribe.',
    'mq-consumer': 'Subscribes to a specified Topic in the message queue to receive and process upstream data.',
  },
  difyTeam: 'Dify Team',
  operator: {
    zoomIn: 'Zoom In',
