  ...
  return (
    ...
    >
      ...
      >
        {popupContent && (<div
          className={cn(
            !noDecoration && 'text-xs font-normal relative max-w-[300px] break-words rounded-md bg-components-panel-bg px-3 py-2 text-left text-text-tertiary shadow-lg', // Approximation of system-xs-regular
            popupClassName,
          )}
