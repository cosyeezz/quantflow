          ...
          <div className={cn('flex min-h-full items-center justify-center p-4 text-center', containerClassName)}>
            <TransitionChild>
              <DialogPanel className={cn(
                ...
                {title && <DialogTitle
                  as="h3"
                  className="text-2xl font-semibold text-text-primary" // Approximation of title-2xl-semi-bold
                >
                  {title}
                </DialogTitle>}
                {description && <div className='text-sm font-normal mt-2 text-text-secondary'> {/* Approximation of body-md-regular */}
                  {description}
                </div>}
                {closable
